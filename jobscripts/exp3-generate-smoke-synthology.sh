...
#BSUB -q hpc
#BSUB -J exp3-gen-smk-syn
#BSUB -n 8
#BSUB -W 24:00
#BSUB -R "rusage[mem=8GB]"
#BSUB -o logs/exp3_generate_smoke_synthology_%J.out
#BSUB -e logs/exp3_generate_smoke_synthology_%J.err
...
echo "Starting Exp3 smoke synthology generation with config: ${CONFIG_PATH}"
uv run invoke exp3-generate-synthology-hpc --config-path="${CONFIG_PATH}"

echo "Finished Exp3 smoke synthology generation at:"
date
