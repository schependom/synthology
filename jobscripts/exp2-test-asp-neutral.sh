...
### General options
#BSUB -q hpc
#BSUB -J exp2-test-asp-neutral
#BSUB -n 4
#BSUB -W 04:00
#BSUB -R "rusage[mem=16GB]"
#BSUB -o logs/exp2_test_asp_neutral_%J.out
#BSUB -e logs/exp2_test_asp_neutral_%J.err
...
RESULTS_DIR="${REPO_ROOT}/results/exp2_asp_neutral_test_$(date +%Y%m%d_%H%M%S)"
mkdir -p "${RESULTS_DIR}"

VARIANTS=(baseline synthology)
CONFIG_NAMES=(exp2_baseline_asp_test exp2_synthology_asp_test)
...
for i in "${!VARIANTS[@]}"; do
	...
	echo "================================================================"
	echo "  ASP Neutral Test: ${variant}"
	echo "  Checkpoint: ${ckpt}"
	echo "  Config: ${config}"
	echo "  Test set: data/asp/family_tree_neutral/test"
	echo "================================================================"
...
print("=" * 110)
print("  Exp2 — ASP NEUTRAL TEST SET (Hohenecker ASP solver)")
print("  Reviewer-requested bias check: neither Synthology nor UDM generated this test set.")
print("=" * 110)
print()
...
print()
print("  (†) = evaluated on the neutral ASP-solver-generated test set.")
print("=" * 110)
...
asp_neutral = existing.get("exp2_asp_neutral", {})
for variant in variants:
    d = data.get(variant, {})
    asp_neutral[variant] = {
...
existing["exp2_asp_neutral"] = asp_neutral
