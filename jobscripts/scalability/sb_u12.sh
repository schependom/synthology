#!/usr/bin/env bash
#BSUB -q hpc
#BSUB -J exp3-scale-sb-u12
#BSUB -w "done(28392119)"
#BSUB -n 8
#BSUB -W 04:00
#BSUB -R "rusage[mem=2GB]"
#BSUB -o /dtu/blackhole/16/221590/synthology/logs/exp3_scale_sb_u12_%J.out
#BSUB -e /dtu/blackhole/16/221590/synthology/logs/exp3_scale_sb_u12_%J.err

# Baked-in parameters
REPO_ROOT="/dtu/blackhole/16/221590/synthology"
SCALE_U="12"
SCALE_CONFIG="/dtu/blackhole/16/221590/synthology/configs/experiments/scalability/exp3_scale_u12.yaml"
