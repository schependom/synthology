#!/usr/bin/env bash
#BSUB -q hpc
#BSUB -J exp3-scale-bl-u4
#BSUB -n 8
#BSUB -W 24:00
#BSUB -R "rusage[mem=14GB] span[hosts=1]"
#BSUB -o /dtu/blackhole/16/221590/synthology/logs/exp3_scale_bl_u4_%J.out
#BSUB -e /dtu/blackhole/16/221590/synthology/logs/exp3_scale_bl_u4_%J.err
