#!/usr/bin/env bash
#BSUB -q hpc
#BSUB -J exp3-scale-sb-u10
#BSUB -w "done(28392117)"
#BSUB -n 8
#BSUB -W 04:00
#BSUB -R "rusage[mem=2GB]"
#BSUB -o /dtu/blackhole/16/221590/synthology/logs/exp3_scale_sb_u10_%J.out
#BSUB -e /dtu/blackhole/16/221590/synthology/logs/exp3_scale_sb_u10_%J.err
