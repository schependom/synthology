...
#             },
#             "negative_sampling": {"strategy": "random", "ratio": 1.0, "corrupt_base_facts": False},
#             "logging": {"level": "INFO"},
#         }
#     )
#     return cfg
...
#     return KGenerator(cfg=mock_cfg, verbose=False)
...
#     ds_gen = KGEDatasetGenerator(cfg=mock_cfg, verbose=False)
